...
- CLI 入口：`run`、`resume`、`preview-run`、`doctor`、`init`、`eval`、`list-runs`、`show-run`、`show-changes`、`show-checkpoint`、`list-tasks`、`show-task`、`list-tools`、`list-providers`、`server`
...
python -m harness.cli list-tasks
python -m harness.cli show-task <task_id>
```
